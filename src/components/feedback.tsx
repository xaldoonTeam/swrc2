    ...
    return (
        <section className="py-20 max-w-7xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center">
            <div>
                ...
                <p className="text-gray-500 mb-8">Read testimonials from our clients. See how our services have made a difference in their lives.</p>
            ...
            <div className="bg-white border-2 border-orange-400 rounded p-6 flex gap-6 relative shadow-lg">
                ...
                <div>
                    ...
                    <p className="text-gray-600 text-sm italic">"Excellent service! The team was punctual, thoroughn. Highly recommend!"</p>
                </div>
